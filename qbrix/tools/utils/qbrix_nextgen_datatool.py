...
class RunDataTool(BaseTask, ABC):
    ...
    def _init_options(self, kwargs):
      ...
      self.data_key = self.options["DataKey"]
    ...
    def _run_task(self):
      ...
      if self.data_key is None or self.data_key == "":
        log.error("Invalid Data Collection ID passed. Please check the ID you have set for the Datakey option and try again.")
        exit
