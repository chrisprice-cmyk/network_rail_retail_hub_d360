...
class RunFuryMode(BaseTask, ABC):
    task_docs = """
    Parallel Task, Flow and Script Runner for Demo Brix. Use with caution.
    """
    ...
    def _run_task(self):
        ...
        execute_tasks_and_flows(
            tasks_and_flows=process_request_list,
