---
description: Enforce best practices for Apex architecture, performance, security, and testing. This rule should be applied when working with Apex classes, triggers, and test classes.
alwaysApply: false
